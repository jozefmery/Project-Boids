...
const data: LanguageDefinition = {
    ...
    startNewSimulation: "Spustiť novú simuláciu",
    ...
    averageEatingThreshold: "Priemerný prah jedenia",
    ...
    averageAlignmentModifier: "Priemerný modifikátor zarovnania",
    averageCohesionModifier: "Priemerný modifikátor súdržnosti",
    averageSeparationModifier: "Priemerný modifikátor oddeľovania",
