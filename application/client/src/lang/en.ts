...
const data: LanguageDefinition = {
    ...
    averageHungerDecay: "Average hunger delta",
    averageEatingThreshold: "Average eating threshold",
    ...
    averageAlignmentModifier: "Average alignment modifier",
    averageCohesionModifier: "Average cohesion modifier",
    averageSeparationModifier: "Average separation modifier",
